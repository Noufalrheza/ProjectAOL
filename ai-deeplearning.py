...
train_images_list = os.listdir('C:\Users\Ahmad Mansyur\Downloads\archive.zip\flickr30k_images\flickr30k_images')
sample_size = 30
...
for i in train_images_list:
    real_images[j] = np.array(plt.imread('C:\Users\Ahmad Mansyur\Downloads\archive.zip\flickr30k_images\flickr30k_images' + i))
    train[j] = np.array(plt.imread('C:\Users\Ahmad Mansyur\Downloads\archive.zip\flickr30k_images\flickr30k_images' + i))
    j += 1
...
train_captions = pd.read_csv('.C:\Users\Ahmad Mansyur\Downloads\archive.zip\flickr30k_imagesresults.csv', delimiter='|')
